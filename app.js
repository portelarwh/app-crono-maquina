...
function closeQtyModal(ok){if(state.pendingLap){const q=ok?n(els.qtyModalInput,0):null;addLap(state.pendingLap.durationMs,q,state.pendingLap.endedAt)}state.pendingLap=null;els.qtyModal.style.display='none'}
