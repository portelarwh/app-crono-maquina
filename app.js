...
const APP_VERSION=window.APP_VERSION||'v5.2.8';
...
function load(){
  try{
    ...
    if(data&&data.state&&typeof data.state==='object'){
      ...
      state.sessionStartTs=Number(data.state.sessionStartTs)||null;
      state.sessionEndTs=Number(data.state.sessionEndTs)||null;
